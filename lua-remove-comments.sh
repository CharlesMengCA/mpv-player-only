...
sed -i -e "s#set_quoted('FULLCONFIG', feature_str)#set_quoted('FULLCONFIG', feature_str.replace('win32 win32-desktop win32-executable win32-internal-pthreads ','').replace('build-date ',''))#g" meson.build
